...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionD8Binding;
...
public class SectionD8Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        try {
            ...
            stcount = db.updatesModuleDColumn(TableContracts.ModuleDTable.COLUMN_ISTATUS, moduleD.getiStatus());
