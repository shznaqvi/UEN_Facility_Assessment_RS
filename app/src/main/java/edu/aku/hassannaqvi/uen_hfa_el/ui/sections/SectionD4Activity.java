...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionD4Binding;
...
public class SectionD4Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleDColumn(TableContracts.ModuleDTable.COLUMN_SD4, moduleD.sD4toString());
