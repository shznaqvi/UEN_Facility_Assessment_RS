...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH5Binding;
...
public class SectionH5Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH5, moduleH.sH5toString());
