...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG44Binding;
...
public class SectionG44Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG44, moduleG.sG44toString());
