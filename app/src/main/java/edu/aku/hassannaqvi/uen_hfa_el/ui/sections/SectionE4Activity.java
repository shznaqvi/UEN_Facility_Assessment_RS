...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionE4Binding;
...
public class SectionE4Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleEColumn(TableContracts.ModuleETable.COLUMN_SE4, moduleE.sE4toString());
