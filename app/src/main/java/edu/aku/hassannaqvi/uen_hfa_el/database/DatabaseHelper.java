package edu.aku.hassannaqvi.uen_hfa_el.database;

import static edu.aku.hassannaqvi.uen_hfa_el.core.MainApp.IBAHC;
...
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_ENTRYLOGS;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_FORMS;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_HEALTH_FACILITY;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_C;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_D;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_E;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_F;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_G;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_H;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_I;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_J;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_K;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_MODULE_M;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_STAFFING;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_USERS;
import static edu.aku.hassannaqvi.uen_hfa_el.database.CreateTable.SQL_CREATE_VERSIONAPP;
...
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.EntryLogTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.FormsTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleCTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleDTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleETable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleFTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleGTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleHTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleITable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleJTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleKTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.ModuleMTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.StaffingTable;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.TableHealthFacilities;
import edu.aku.hassannaqvi.uen_hfa_el.contracts.TableContracts.UsersTable;
...
import edu.aku.hassannaqvi.uen_hfa_el.models.VersionApp;
...
//            values.put(TableHealthFacilities.COLUMN_UC_NAME, hf.getUcName());
    ...
    public JSONArray getUnsyncedStaffing() throws JSONException {
        ...
        whereClause = StaffingTable.COLUMN_SYNCED + " ='' AND " +
                StaffingTable.COLUMN_ISTATUS + "= '1'";
        String[] whereArgs = null;
        String groupBy = null;
        String having = null;
