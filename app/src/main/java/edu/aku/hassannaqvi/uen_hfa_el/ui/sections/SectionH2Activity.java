...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH2Binding;
...
public class SectionH2Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH2, moduleH.sH2toString());
