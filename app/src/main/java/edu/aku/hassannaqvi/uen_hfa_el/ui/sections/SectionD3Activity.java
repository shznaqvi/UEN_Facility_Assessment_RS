...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionD3Binding;
...
public class SectionD3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleDColumn(TableContracts.ModuleDTable.COLUMN_SD3, moduleD.sD3toString());
