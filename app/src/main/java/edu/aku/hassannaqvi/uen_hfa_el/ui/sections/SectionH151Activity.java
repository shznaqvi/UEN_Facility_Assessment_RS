...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH151Binding;
...
public class SectionH151Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH151, moduleH.sH151toString());
