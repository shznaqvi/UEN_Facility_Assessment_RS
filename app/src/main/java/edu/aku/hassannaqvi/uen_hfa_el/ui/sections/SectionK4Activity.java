...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionK4Binding;
import edu.aku.hassannaqvi.uen_hfa_el.ui.SectionMainActivity;

public class SectionK4Activity extends AppCompatActivity {

    private static final String TAG = "SectionK4Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleKColumn(TableContracts.ModuleKTable.COLUMN_SK4, moduleK.sK4toString());
