...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG45Binding;
...
public class SectionG45Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG45, moduleG.sG45toString());
