...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH10Binding;
...
public class SectionH10Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH10, moduleH.sH10toString());
