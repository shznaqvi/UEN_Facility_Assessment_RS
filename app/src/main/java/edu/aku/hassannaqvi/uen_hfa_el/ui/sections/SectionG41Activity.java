...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG41Binding;
import edu.aku.hassannaqvi.uen_hfa_el.ui.SectionMainActivity;


public class SectionG41Activity extends AppCompatActivity {

    private static final String TAG = "SectionG41Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG41, moduleG.sG41toString());
