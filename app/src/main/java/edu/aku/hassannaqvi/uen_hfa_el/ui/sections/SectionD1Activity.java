...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionD1Binding;
...
public class SectionD1Activity extends AppCompatActivity {
    ...
    private boolean insertNewRecord() {
        ...
        if (rowId > 0) {
            ...
            moduleD.setUid(MainApp.generateUid(moduleD.getDeviceId()));
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleDColumn(TableContracts.ModuleDTable.COLUMN_SD1, moduleD.sD1toString());
        } catch (JSONException e) {
            e.printStackTrace();
