...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH6Binding;
...
public class SectionH6Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH6, moduleH.sH6toString());
