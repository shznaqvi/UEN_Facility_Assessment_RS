...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionJ3Binding;
...
public class SectionJ3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleJColumn(TableContracts.ModuleJTable.COLUMN_SJ3, moduleJ.sJ3toString());
