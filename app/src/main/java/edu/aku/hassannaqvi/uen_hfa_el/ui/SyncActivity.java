...
import static edu.aku.hassannaqvi.uen_hfa_el.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.uen_hfa_el.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.uen_hfa_el.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.uen_hfa_el.models.SyncModel;
import edu.aku.hassannaqvi.uen_hfa_el.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.uen_hfa_el.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.uen_hfa_el.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnUpload:
                ...
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleC());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleC): " + e.getMessage());
                ...
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleD());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleD): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleD)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }

                //ModuleE
                uploadTables.add(new SyncModel(TableContracts.ModuleETable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleE());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleE): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleE)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }

                //ModuleF
                uploadTables.add(new SyncModel(TableContracts.ModuleFTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleF());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleF): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleF)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }

                //ModuleG
                uploadTables.add(new SyncModel(TableContracts.ModuleGTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleG());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleG): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleG)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }

                //ModuleH
                uploadTables.add(new SyncModel(TableContracts.ModuleHTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleH());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleH): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleH)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }
                ...
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleJ());
                } catch (JSONException e) {
                    e.printStackTrace();
                ...
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleK());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleK): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleK)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }

                //ModuleM
                uploadTables.add(new SyncModel(TableContracts.ModuleMTable.TABLE_NAME));
                try {
                    MainApp.uploadData.add(db.getUnsyncedModuleM());
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "ProcessStart: JSONException(ModuleM): " + e.getMessage());
                    Toast.makeText(SyncActivity.this, "JSONException(ModuleM)" + e.getMessage(), Toast.LENGTH_LONG).show();
                }
