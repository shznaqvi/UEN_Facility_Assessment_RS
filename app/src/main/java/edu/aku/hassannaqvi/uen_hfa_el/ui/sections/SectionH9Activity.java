...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionH9Binding;
...
public class SectionH9Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH9, moduleH.sH9toString());
