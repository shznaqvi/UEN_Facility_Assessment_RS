...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionJ8Binding;
...
public class SectionJ8Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleJColumn(TableContracts.ModuleJTable.COLUMN_SJ8, moduleJ.sJ8toString());
        } catch (JSONException e) {
            e.printStackTrace();
