...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionJ4Binding;
...
public class SectionJ4Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleJColumn(TableContracts.ModuleJTable.COLUMN_SJ4, moduleJ.sJ4toString());
