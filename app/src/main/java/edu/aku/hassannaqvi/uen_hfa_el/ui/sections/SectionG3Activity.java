...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG3Binding;
...
public class SectionG3Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG3, moduleG.sG3toString());
