...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionJ6Binding;
...
public class SectionJ6Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleJColumn(TableContracts.ModuleJTable.COLUMN_SJ6, moduleJ.sJ6toString());
