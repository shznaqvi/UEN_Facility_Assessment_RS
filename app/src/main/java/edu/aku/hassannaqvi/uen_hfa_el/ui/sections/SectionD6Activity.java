...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionD6Binding;
...
public class SectionD6Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleDColumn(TableContracts.ModuleDTable.COLUMN_SD6, moduleD.sD6toString());
