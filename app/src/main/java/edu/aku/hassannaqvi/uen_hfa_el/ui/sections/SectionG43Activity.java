...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG43Binding;
...
public class SectionG43Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG43, moduleG.sG43toString());
