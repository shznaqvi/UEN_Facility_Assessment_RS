...
import edu.aku.hassannaqvi.uen_hfa_el.databinding.ActivitySectionG42Binding;
import edu.aku.hassannaqvi.uen_hfa_el.ui.SectionMainActivity;


public class SectionG42Activity extends AppCompatActivity {

    private static final String TAG = "SectionG42Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleGColumn(TableContracts.ModuleGTable.COLUMN_SG42, moduleG.sG42toString());
