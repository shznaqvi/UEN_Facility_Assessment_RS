...
import static edu.aku.hassannaqvi.uen_facility_assessment.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.uen_facility_assessment.core.MainApp.uploadData;
...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.uen_facility_assessment.models.SyncModel;
import edu.aku.hassannaqvi.uen_facility_assessment.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.uen_facility_assessment.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.uen_facility_assessment.workers.PhotoUploadWorker2;
    ...
    public void ProcessStart(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnUpload:
                ...
                try {
                    uploadData.add(db.getUnsyncedModuleM());
                } catch (JSONException e) {
                    e.printStackTrace();
