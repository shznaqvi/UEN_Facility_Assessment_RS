...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySectionK2Binding;
...
public class SectionK2Activity extends AppCompatActivity {
    ...
    private static final String TAG = "SectionK2Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleKColumn(TableContracts.ModuleKTable.COLUMN_SK2, moduleK.sK2toString());
