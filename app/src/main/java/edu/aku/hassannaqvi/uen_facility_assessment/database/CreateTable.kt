...
object CreateTable {
    ...
    const val SQL_CREATE_MODULE_B = ("CREATE TABLE "
            ...
            + ModuleBTable.COLUMN_UUID + " TEXT,"
            + ModuleBTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleBTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleBTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleBTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_C = ("CREATE TABLE "
            ...
            + ModuleCTable.COLUMN_UUID + " TEXT,"
            + ModuleCTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleCTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleCTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleCTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_STAFFING = ("CREATE TABLE "
            ...
            + StaffingTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + StaffingTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + StaffingTable.COLUMN_UC_CODE + " TEXT,"
            + StaffingTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_D = ("CREATE TABLE "
            ...
            + ModuleDTable.COLUMN_UUID + " TEXT,"
            + ModuleDTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleDTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleDTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleDTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_E = ("CREATE TABLE "
            ...
            + ModuleETable.COLUMN_UUID + " TEXT,"
            + ModuleETable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleETable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleETable.COLUMN_UC_CODE + " TEXT,"
            + ModuleETable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_F = ("CREATE TABLE "
            ...
            + ModuleFTable.COLUMN_UUID + " TEXT,"
            + ModuleFTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleFTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleFTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleFTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_G = ("CREATE TABLE "
            ...
            + ModuleGTable.COLUMN_UUID + " TEXT,"
            + ModuleGTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleGTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleGTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleGTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_H = ("CREATE TABLE "
            ...
            + ModuleHTable.COLUMN_UUID + " TEXT,"
            + ModuleHTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleHTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleHTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleHTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_I = ("CREATE TABLE "
            ...
            + ModuleITable.COLUMN_UUID + " TEXT,"
            + ModuleITable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleITable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleITable.COLUMN_UC_CODE + " TEXT,"
            + ModuleITable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_J = ("CREATE TABLE "
            ...
            + ModuleJTable.COLUMN_UUID + " TEXT,"
            + ModuleJTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleJTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleJTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleJTable.COLUMN_HF_CODE + " TEXT,"
    ...
    const val SQL_CREATE_MODULE_K = ("CREATE TABLE "
            ...
            + ModuleKTable.COLUMN_UUID + " TEXT,"
            + ModuleKTable.COLUMN_DISTRICT_CODE + " TEXT,"
            + ModuleKTable.COLUMN_TEHSIL_CODE + " TEXT,"
            + ModuleKTable.COLUMN_UC_CODE + " TEXT,"
            + ModuleKTable.COLUMN_HF_CODE + " TEXT,"
