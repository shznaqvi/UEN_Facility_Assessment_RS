...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySectionJ5Binding;
...
public class SectionJ5Activity extends AppCompatActivity {
    ...
    private static final String TAG = "SectionJ5Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleJColumn(TableContracts.ModuleJTable.COLUMN_SJ5, moduleJ.sJ5toString());
