...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySectionE6Binding;
...
public class SectionE6Activity extends AppCompatActivity {
    ...
    private static final String TAG = "SectionE6Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleEColumn(TableContracts.ModuleETable.COLUMN_SE6, moduleE.sE6toString());
