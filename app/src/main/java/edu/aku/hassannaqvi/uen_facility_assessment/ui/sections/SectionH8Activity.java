...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySectionH8Binding;

public class SectionH8Activity extends AppCompatActivity {

    private static final String TAG = "SectionH8Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH8, moduleH.sH8toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            startActivity(new Intent(this, SectionH9Activity.class));
