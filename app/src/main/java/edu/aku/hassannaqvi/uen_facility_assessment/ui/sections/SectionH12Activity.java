...
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivitySectionH12Binding;
...
public class SectionH12Activity extends AppCompatActivity {
    ...
    private static final String TAG = "SectionH12Activity";
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesModuleHColumn(TableContracts.ModuleHTable.COLUMN_SH12, moduleH.sH12toString());
