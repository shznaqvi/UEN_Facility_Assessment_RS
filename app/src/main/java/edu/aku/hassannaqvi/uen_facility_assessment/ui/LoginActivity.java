...
import static edu.aku.hassannaqvi.uen_facility_assessment.core.MainApp.editor;
...
import static edu.aku.hassannaqvi.uen_facility_assessment.core.UserAuth.generatePassword;
import static edu.aku.hassannaqvi.uen_facility_assessment.database.CreateTable.DATABASE_COPY;
...
import edu.aku.hassannaqvi.uen_facility_assessment.core.AppInfo;
import edu.aku.hassannaqvi.uen_facility_assessment.core.MainApp;
import edu.aku.hassannaqvi.uen_facility_assessment.database.DatabaseHelper;
import edu.aku.hassannaqvi.uen_facility_assessment.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.uen_facility_assessment.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            Intent iLogin = new Intent(edu.aku.hassannaqvi.uen_facility_assessment.ui.LoginActivity.this, MainActivity.class);
